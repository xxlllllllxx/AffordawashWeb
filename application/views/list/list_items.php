    ...
    <div class="item_record">
        <form class="update_form" method="POST" action="<?= base_url('main/updateItem'); ?>">
            ...
            <div class="text_white">
                ...
                <div>COST: <input class="input" type="number" name="cost" value="<?= $item['cost']; ?>"
                        placeholder="<?= $item['cost']; ?>"></div>
                <div>LOWEST PRICE: <input class="input" type="number" name="lprice"
                        value="<?= $item['lowest_price']; ?>" placeholder="<?= $item['lowest_price']; ?>"></div>
                <div>SELLING PRICE<input class="input" type="number" name="sprice"

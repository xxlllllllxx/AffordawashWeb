<div class="panel">
    ...
    <form class="add_form" action="<?= base_url('main/changePass/') ?>" method="POST">
        ...
        <input class="send input" type="submit" value="SAVE" formaction="<?= base_url('main/changePass/save') ?>">
        <input class="send input" type="submit" value="BACK" formaction="<?= base_url('main/changePass/back') ?>">
    </form>
</div>
<style>
    .add {
